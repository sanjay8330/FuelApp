...
public class EndpointURL {
    ...
    public static final String GET_USER_BY_UN_PW = "http://" + endpointAddress + "/api/Users/";
    public static final String GET_CUSTOMER_BY_NAME = "http://" + endpointAddress + "/customerService/";

    public static final String GET_USER_BY_ID = "http://" + endpointAddress + "/api/Users/";
    public static final String ADD_FUEL = "http://" + endpointAddress + "/api/Fuel";
